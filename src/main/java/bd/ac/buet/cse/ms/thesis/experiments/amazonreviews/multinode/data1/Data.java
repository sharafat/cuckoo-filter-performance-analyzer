...
public abstract class Data  implements DataProvider<String> {
    ...
    private static final String LOOKUP_AFTER_DELETION_QUERY = "SELECT * FROM amazon_reviews WHERE product_category IN ('Home_Improvement', 'Outdoors', 'Kitchen', 'Digital_Video_Games', 'Beauty', 'Mobile_Electronics', 'PC', 'Personal_Care_Appliances', 'Toys', 'Software', 'Digital_Video_Download', 'Camera', 'Music', 'Tools', 'Sports', 'Software');";
